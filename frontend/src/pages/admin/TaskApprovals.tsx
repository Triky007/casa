...
import { FaCheckCircle, FaTimesCircle, FaExclamationTriangle, FaSearch, FaUser } from 'react-icons/fa';
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-gray-500">Evidencia</h4>
                        <p className="text-base">{selectedSubmission.evidence || "No hay evidencia adjunta"}</p>
                      </div>
                      <div>
